...
pub struct InstantiateMsg {
    ...
    pub symbol: String,
    pub decimals: u8,
    // the price of the ABT token
    pub token_price: Uint128,
    // the USDC address to use
    pub usdc_address: String,
    // The owner of the initial balances
    pub owner: String,
...
impl From<QueryMsg> for Cw20QueryMsg {
    fn from(msg: QueryMsg) -> Self {
        match msg {
            ...
            QueryMsg::IncreaseAllowancePurchase { owner, spender } => Cw20QueryMsg::Allowance { owner, spender} ,
